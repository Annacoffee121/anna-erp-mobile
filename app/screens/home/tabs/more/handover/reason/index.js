...
let data = [{value: 'Shop Closed'}, {value: 'Shop Owner Not Available'}, {value: 'Stock Available'},
    {value: 'Customer Not Interested'}, {value: 'Vehicle Repaired'}, {value: 'Road Closed, Unable to Reach Customer'},
    {value: 'Stock is not available to deliver'}, {value: 'Credit limit is over'}, {value: 'Time is not enough to cover'}];

export default class NotVisitedReasonTab extends Component {
    constructor(props) {
        super(props);
        this.state = {
            refreshing: false,
    ...
    render() {
        return (
            <View style={{flex: 1}}>
                <ScreenHeader name='Not Visited Reason'
